...
const skill_90 = document.getElementById("skillbar__95");
const skill_80 = document.getElementById("skillbar__90");
const skill_75 = document.getElementById("skillbar__75");
const skill_45 = document.getElementById("skillbar__50");
const skill_40 = document.getElementById("skillbar__45");
...
function nav() {
  if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
    ...
    skill_90.classList.add("skillbar__95");
    skill_80.classList.add("skillbar__90");
    skill_75.classList.add("skillbar__75");
    skill_45.classList.add("skillbar__50");
    skill_40.classList.add("skillbar__45");
